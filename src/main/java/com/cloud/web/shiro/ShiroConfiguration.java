 ...
 * @author: HeYongLiu
 * @create: 06-21-2019
 * @description: Shiro 的主要配置信息都在此文件内实现
 **/
@Configuration
...
//    }
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        shiroFilterFactoryBean.setLoginUrl("/cloud/login");
        // 登录成功后要跳转的连接
        shiroFilterFactoryBean.setSuccessUrl("/cloud/index");
        shiroFilterFactoryBean.setUnauthorizedUrl("/cloud/denied");
